/*
    Compilation:
        gcc -o SPI_thread SPI_thread.c -l wiringPi -l pthread
*/
#include <stdio.h>
#include <stdint.h>
#include <fcntl.h>
...
void gpio_callback0(void) {
    ...
    delayMicroseconds(300); // this is really important, DON'T delete
